            ...
            <div class="filter-wrapper">
              ...
              <div class="condition-wrapper">
                <span v-for="(item,index) in hostypeList" :key="index"
                  ...
                  class="item v-link clickable"  @click="hostypeSelect(item.value, index)">{{item.name}}</span>
              </div>
            </div>
            <div class="filter-wrapper">
              ...
              <div class="condition-wrapper">
                <span v-for="(item,index) in districtList" :key="index" 
                  ...
                  class="item v-link clickable" @click="districtSelect(item.value, index)">{{item.name}}</span>
              </div>
            </div>
          </div>
        </div>
